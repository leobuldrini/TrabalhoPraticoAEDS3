...
public class CRUDSequencial {
        ...
        do{
            ...
            switch (op) {
                ...
                case 2:
                    ...
                    Breach breach = registros.retrieveBreachSequentially(Integer.parseInt(inputId));
                    if(breach != null){
                        System.out.println("\n" + breach);
                    }else{
                ...
                case 5:
                    ...
                    Breach breachToDelete = registros.retrieveBreachSequentially(Integer.parseInt(inputIdDelete));
    ...
    private void printMenu() {
        System.out.println("\tBEM VINDO AO CRUD SEQUENCIAL\nEscolha sua ação:\n");
