...
*/
            exHash.insert(new KeyAddressPair(5, 2308923));
            exHash.insert(new KeyAddressPair(1, 24));
            exHash.insert(new KeyAddressPair(2, 24));
            exHash.insert(new KeyAddressPair(3, 24));
            exHash.insert(new KeyAddressPair(7, 24));
            exHash.insert(new KeyAddressPair(9, 0xFFFFFFFFFL));
            exHash.insert(new KeyAddressPair(4, 24));
            exHash.insert(new KeyAddressPair(6, 24));
            exHash.insert(new KeyAddressPair(8, 24));
            exHash.insert(new KeyAddressPair(0, 24));
            System.out.println(exHash.retrieveAddress(9));
