...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        //Adaptação do caminho de arquivos dependendo do sistema do Usuário
        ...
        //Instância de Hash Extendido
        ExtendedHash exHash = new ExtendedHash(4, userDir + "/dataset/buckets.hash", userDir + "/dataset/index.hash");
        //Set de palavras a serem desconsideras dentro do íncide de lista invertida
